...
const Header = () => {
    return (
        <div className="bg-orange-500 p-2 text-white flex justify-between items-center">
            <div><h1 className="text-xl pl-60">PIM</h1></div>
            <div className="flex items-center cursor" id="dropdownDefaultButton" data-dropdown-toggle="dropdown" type="button" style={{ backgroundColor: "#f46016", opacity: '60', borderRadius: '50px', padding: '5px' }}>
                <div className="bg-white rounded-full p-2">
                    <img src="/path_to_your_user_icon.jpg" alt="User" className="w-8 h-8 rounded-full" />
                </div>
                <span className="mr-2">John User</span>
